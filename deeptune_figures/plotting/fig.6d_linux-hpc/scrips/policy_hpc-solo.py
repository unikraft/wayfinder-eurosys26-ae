...
# -*- coding: utf-8 -*-
"""
HPC Sampling Policy Visualization

This script generates performance comparison plots for HPC tuning strategies:
...
WAYFINDER_TL_DATA_FOLDER = 'linux-hpc-redis-tl'
DATA_OUTPUT = '../pdfs/'
RANDOM_DATA_FILE = '../../../measurements/linux-hpc_default_56.xlsx'

N_SAMPLES = 250
N_TRIALS = 5
SMOOTHING_WINDOW = 100
DEFAULT_VALUE = 1497.61
...
def main():
    ...
    time_samples = [72.44, 72.21, 74.82, 122.35, 122.31, 137.43,
                   132.34, 34.73, 34.66, 34.78, 34.76, 34.68]
    ...
    output_path = os.path.join(DATA_OUTPUT, 'new_linux-hpc_sampling_policy_no-tf.pdf')
