...
# -*- coding: utf-8 -*-
"""
REDIS Sampling Policy Visualization

This script generates performance comparison plots for REDIS tuning strategies:
...
WAYFINDER_TL_DATA_FOLDER = 'linux-redis_sqlite-tl'
DATA_OUTPUT = '../pdfs/'
RANDOM_DATA_FILE = '../../../measurements/linux-redis_3_only_OS_single_core.xlsx'
...
def main():
    ...
    time_samples = [150.49, 72.53, 72.56, 65.01, 67.57, 85.04, 72.60, 45.09, 45.03, 45.04, 45.02, 45.00]
    ...
    ax1.legend(lines1 + lines2, labels1 + labels2, ncol=3, bbox_to_anchor=(0.5, 1.02), loc='upper center')

    # Save figure
    os.makedirs(DATA_OUTPUT, exist_ok=True)
    output_path = os.path.join(DATA_OUTPUT, 'new_linux-redis_sampling_policy_no-tf.pdf')
